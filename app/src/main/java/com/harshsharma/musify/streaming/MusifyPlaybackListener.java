package com.harshsharma.musify.streaming;
...
public class MusifyPlaybackListener
        implements PlaybackListener, AudioManager.OnAudioFocusChangeListener,
        OnCompletionListener, OnErrorListener, OnPreparedListener, OnSeekCompleteListener {
    private static final String TAG = Logger.makeLogTag(MusifyPlaybackListener.class);
    ...
    public MusifyPlaybackListener(Context context) {
    ...
    @Override
    public void play(TrackMetaData item) {
        mPlayOnFocusGain = true;
        tryToGetAudioFocus();
        registerAudioNoisyReceiver();
        String mediaId = item.getTrackId();
        ...
        if (mState == PlaybackStateCompat.STATE_PAUSED && !mediaHasChanged && mMediaPlayer != null) {
            ...
            String source = item.getTrackUrl();
            if (source != null) {
